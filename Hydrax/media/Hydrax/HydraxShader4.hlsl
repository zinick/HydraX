...
//   Refraction: Texture
//   Reflection: Texture
//   Additional Effects: Sunlight, Foam
...
void main_fp(// IN
             ...
             uniform sampler1D    uFresnelMap      : register(s3),
             uniform sampler2D    uHeightMap       : register(s4),
             uniform sampler2D    uFoamMap         : register(s5))
{
    ...
    //compute the additiona reflection using  the "fullReflectionDistance" param
    additionalReflection/=uFullReflectionDistance;

    camToSurface=normalize(-camToSurface);

    //get our normal pixel
